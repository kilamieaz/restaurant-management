                ...
                <div class="col-lg-7">
                    <div class="newsletter-area">
                        <div class="newsletter-info">
                            <h3 class="heading">Sign Up For Newsletter & Get All Updates</h3>
                            <p class="short-desc">Lorem Ipsum is simply dummy text of the printing and
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-6">
                    ...
                    <div class="footer-widgets">
                        <ul>
                            ...
                            <li><a href="javascript:void(0)">Network Status</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-6">
                    <div class="footer-widgets_title">
                        <h4>Social Netowrk</h4>
                    </div>
                    <div class="footer-widgets">
                        <ul>
